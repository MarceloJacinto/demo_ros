...
Adapted from: https://gist.github.com/rossbar/ebb282c3b73c41c1404123de6cea4771
"""
import rospy
import yaml
...
if __name__ == "__main__":
    ...
    rospy.logwarn("Loading calibration from:" + filename)
    rospy.logwarn("Using base camera:" + camera_topic)
